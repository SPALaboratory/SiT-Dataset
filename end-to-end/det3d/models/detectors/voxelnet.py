...
class VoxelNet(SingleStageDetector):
    ...
    def forward(self, example, return_loss=True, **kwargs):
        ...
        if return_loss:
            ...
            if example['metadata'][0]['token'] == '230409_sungsu_slam*outdoor_1_2023-04-09-15-17-57_sync_odom_offset-2_-2_-1_-1_-1_cut31_20sec_5hz*1681021688432488441':
                print(1)
            if vis_flag:
                ...
                mask = (scores[np.argsort(scores)[::-1]] >0.2)
                ...
                points = example['points'][:, 1:].clone().detach().cpu().numpy()
