    ...
    def __call__(self, res, info):
        ...
        if self.mode == "train":
            gt_dict = {
                ...
                'gt_track_id': [np.array(box).reshape(-1) for box in anno_dict["track_id"]],
            }
        ...
        if self.mode == "train" and not self.no_augmentation:
            ...
            # for idx in range(len(gt_boxes_mask)):
            #     if gt_boxes_mask[idx].shape[0] != gt_boxes_mask[0].shape[0]:
            #         print("fxxk")
