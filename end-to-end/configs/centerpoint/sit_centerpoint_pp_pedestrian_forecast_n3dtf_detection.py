...
test_cfg = dict(
    ...
    post_center_limit_range=[-41., -41., -10.0, 41., 41., 10.0],
    max_per_img=500,
    nms=dict(
...
nsweeps = 10
data_root = "./data/sit/trainval_forecast"
...
train_preprocessor = dict(
    ...
    global_rot_noise=None,
    global_scale_noise=None,
...
test_anno = data_root + "/infos_val_10sweeps_withvelo_filter_True.pkl"
# val_anno = data_root + "/infos_train_10sweeps_withvelo_filter_True.pkl"
# test_anno = data_root + "/infos_train_10sweeps_withvelo_filter_True.pkl"
