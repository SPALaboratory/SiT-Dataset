...
# test_cfg = dict(
#     # post_center_limit_range=[-51, -51, -5.0, 51, 51, 3.0],
...
# nsweeps = 1
# data_root = "./data/spa/trainval_forecast"
...
#     sample_group=[
#         #dict(static_car=2),
#         dict(static_pedestrian=4),
#         #dict(linear_car=4),
#         dict(linear_pedestrian=4),
...
# # load_from = '/home/changwon/detection_task/Det3D/models/FutureDetection/spa_nus_centerpoint_pedestrian_forecast_n3dtf_detection/epoch_100.pth'
# load_from = None
# resume_from = None 
# workflow = [('train', 1)]
