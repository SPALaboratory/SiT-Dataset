...
parser.add_argument('--save_file', '-sf', type=str, default='SDD_nsp_wo_v1_SiT')
...
load_path = 'saved_models/Goals_SiT.pt'
...
path_train = 'preprocess/processed_data_SiT/train_pickle/'
scenes_train = os.listdir(path_train)
path_test = 'preprocess/processed_data_SiT/val_pickle/'
scenes_test = os.listdir(path_test)
semantic_path_train = 'semantic_map/train_masks/'
semantic_maps_name_train = os.listdir(semantic_path_train)
semantic_path_test = 'semantic_map/val_masks/'
semantic_maps_name_test = os.listdir(semantic_path_test)

goals_path = 'result_SiT/result_goal20'
