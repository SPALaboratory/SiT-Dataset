...
def train(path, scenes, isSemanticMap):
    ...
    for i in tqdm(shuffle_index):
        ...
        for index in range(0, traj_complete_translated_total.shape[0], batch):
            ...
            semantic_map = cv2.imread(semantic_path_train + (scene_name+'.png')) 
...
parser.add_argument('--save_file', '-sf', type=str, default='SiT_nsp_wo_complete_1_wo_maps_v1')
...
load_path = 'saved_models/SiT_goals_no_maps_v1.pt'
