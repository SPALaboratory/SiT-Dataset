...
from test_spa_no_sem import evaluate
from train_spa_no_sem import train
...
class YNet:
	...
	def train(self, train_data, val_data, params, train_image_path, val_image_path, experiment_name, batch_size=8, num_goals=20, num_traj=1, device=None, dataset_name=None, resume=False):
		"""
		Train function
		...
		scheduler = MultiStepLR(optimizer, milestones=[15,30,40,50], gamma=0.1)
