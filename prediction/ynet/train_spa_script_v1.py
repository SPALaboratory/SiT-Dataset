...
CONFIG_FILE_PATH = 'config/spa_0307v1_1.yaml'  # yaml config file containing all the hyperparameters
EXPERIMENT_NAME = 'spa_0307v1_1'  # arbitrary name for this experiment
DATASET_NAME = 'spa'
