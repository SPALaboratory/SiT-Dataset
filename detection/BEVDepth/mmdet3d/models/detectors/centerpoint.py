...
class CenterPoint(MVXTwoStageDetector):
    ...
    def forward_pts_train(self,
        ...
        """
        outs = self.pts_bbox_head(pts_feats) #pts_feats -> bev feature input값 -> input을 self.bbox_head 작업을 통해 pred_outs 추출
        loss_inputs = [gt_bboxes_3d, gt_labels_3d, outs]
        losses = self.pts_bbox_head.loss(*loss_inputs) #centerpoint_head.loss():607line
        return losses
