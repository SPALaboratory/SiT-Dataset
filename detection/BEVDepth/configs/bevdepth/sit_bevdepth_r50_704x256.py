...
voxel_size = [0.078125, 0.078125, 0.2] 

numC_Trans = 80 #number of channel transformer
...
test_data_config = dict(
    ...
    ann_file=data_root + 'sit_bev_infos_test.pkl')
...
data = dict(
    ...
    train=dict(
        data_root=data_root,
        ann_file=data_root + 'sit_bev_infos_train.pkl',
