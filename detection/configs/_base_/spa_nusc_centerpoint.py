_base_ = [
    ...
    '../_base_/models/centerpoint_02pillar_second_secfpn_spa_nus.py',
...
db_sampler = dict(
    ...
    #     motorcycle=0,
    #     bicycle=0,
    #     pedestrian=0,), #car 0.27, bi 0, motor 0.03, ped 0.351
    sample_groups=dict(
        car=2,
        motorcycle=6,
        bicycle=6,
...
load_from = None
# resume_from = '/home/changwon/detection_task/mmdetection3d/work_dirs/spa_nusc_centerpoint/latest.pth'
resume_from = None
