    ...
    for i in range(num_rects):
        ...
        for start, end in line_indices:
            cv2.line(img, (corners[start, 0], corners[start, 1]),
                     ...
                     cv2.LINE_AA)
        cv2.line(img, ((corners[4,0]+corners[5,0])//2, (corners[4,1]+corners[5,1])//2),
                 ((corners[4,0]+corners[5,0]+corners[0,0]+corners[1,0])//4,
                  (corners[4,1]+corners[5,1]+corners[0,1]+corners[1,1])//4), (255,0,0), thickness,
                    cv2.LINE_AA)
        cv2.line(img, ((corners[7,0]+corners[6,0])//2, (corners[7,1]+corners[6,1])//2),
                 ((corners[7,0]+corners[6,0]+corners[2,0]+corners[3,0])//4,
                  (corners[7,1]+corners[6,1]+corners[2,1]+corners[3,1])//4), (255,0,0), thickness,
                    cv2.LINE_AA)
...
def draw_camera_bbox3d_on_img(bboxes3d,
    ...
    if not isinstance(cam2img, torch.Tensor):
        cam2img = torch.from_numpy(np.array(cam2img[0]))
