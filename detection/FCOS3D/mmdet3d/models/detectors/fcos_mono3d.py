...
from .single_stage_mono3d import SingleStageMono3DDetector, SingleStageMono3DDetector_MV
...
@DETECTORS.register_module()
class FCOSMono3D_MV(SingleStageMono3DDetector_MV):
    r"""`FCOS3D <https://arxiv.org/abs/2104.10956>`_ for monocular 3D object detection.
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(FCOSMono3D_MV, self).__init__(backbone, neck, bbox_head, train_cfg,
                                         test_cfg, pretrained)
