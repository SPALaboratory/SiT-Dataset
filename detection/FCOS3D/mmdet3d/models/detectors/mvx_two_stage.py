...
class MVXTwoStageDetector(Base3DDetector):
    ...
    def forward_train(self,
        ...
        vis_flag = False
        if vis_flag:
            save_path = "./mmdetection3d/viz_in_model/gt/"
            gt_=[]
            for batch in range(len(gt_bboxes_3d)):
                ...
                np.save("./mmdetection3d/viz_in_model/3d_viz/pc/{}.npy".format(img_metas[0]['sample_idx'].split("*")[-1]), points_)
                file = open("./mmdetection3d/viz_in_model/3d_viz/box/{}.txt".format(img_metas[0]['sample_idx'].split("*")[-1]), "w")
                with open("./mmdetection3d/viz_in_model/3d_viz/box/{}.txt".format(img_metas[0]['sample_idx'].split("*")[-1]), "w") as f:
