...
from tools.data_converter import sit_converter_mono as sit_nus_converter
...
def sit_nus_data_prep(root_path,
                       info_prefix,
                       version,
                       dataset_name,
                       out_dir,
    ...
    sit_nus_converter.create_sit_nus_infos_mono(
        root_path, info_prefix, version=version, max_sweeps=max_sweeps)
    if version == 'v1.0-sit-test':
        info_test_path = osp.join(root_path, f'{info_prefix}_infos_test.pkl')
        sit_nus_converter.export_2d_annotation(
            root_path, info_test_path, version=version, test = True)
        return
    ...
    if not mono:
        create_groundtruth_database(dataset_name, root_path, info_prefix,
                                f'{out_dir}/{info_prefix}_GT_infos_train.pkl')
        create_groundtruth_database(dataset_name, root_path, info_prefix,
                                f'{out_dir}/{info_prefix}_GT_infos_val.pkl')
...
if __name__ == '__main__':
    ...
    elif args.dataset == 'sit_nus' and args.version == 'v1.0-sit-trainval':
        train_version = f'{args.version}'
        sit_nus_data_prep(
            root_path=args.root_path,
            info_prefix=args.extra_tag,
            version=train_version,
            dataset_name='Sit_Nus_Dataset',
            out_dir=args.out_dir,
            max_sweeps=args.max_sweeps)
    elif args.dataset == 'sit_nus' and args.version == 'v1.0-sit-test':
        test_version = 'v1.0-sit-test'
        sit_nus_data_prep(
            root_path=args.root_path,
            info_prefix=args.extra_tag,
