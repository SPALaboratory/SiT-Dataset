...
def create_groundtruth_database(dataset_class_name,
    ...
    elif dataset_class_name == 'Sit_Nus_Dataset':
        dataset_cfg.update(
            use_valid_flag=True,
            pipeline=[
                dict(
    ...
    elif dataset_class_name == 'SiT_Nus_Dataset_Top':
        dataset_cfg.update(
            use_valid_flag=True,
            pipeline=[
                dict(
    ...
    elif dataset_class_name == 'SiT_Nus_Dataset_Bottom':
        dataset_cfg.update(
            use_valid_flag=True,
            pipeline=[
                dict(
    ...
    for j in track_iter_progress(list(range(len(dataset)))):
        ...
        gt_boxes_corners = sit_nus_converter_back.box_center_to_corner_3d(gt_boxes_3d[:, :3], gt_boxes_3d[:, 3:6], gt_boxes_3d[:, 6])
        num_pts_list = sit_nus_converter_back.get_pts_index_in_3dbox_(points, gt_boxes_corners)
