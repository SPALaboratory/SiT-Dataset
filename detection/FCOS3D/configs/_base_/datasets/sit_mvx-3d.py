...
db_sampler = dict(
    data_root=data_root,
    info_path=data_root + 'sit_mvx_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
data = dict(
    ...
    #     type=dataset_type,
    #     data_root=data_root,
    #     ann_file=data_root + 'sit_nusc_infos_train.pkl',
    ...
    train=dict(
        ...
        dataset=dict(
                        type=dataset_type,
                        data_root=data_root,
                        ann_file=data_root + 'sit_mvx_infos_train.pkl',
                        pipeline=train_pipeline,
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'sit_mvx_infos_val.pkl',
        split='training',
        pts_prefix='velodyne_reduced',
    ...
    #     pipeline=test_pipeline,
    #     classes=class_names,
    #     ann_file=data_root + 'sit_nusc_infos_val.pkl',
    #     with_velocity=with_velocity),
    # test=dict(
    #     pipeline=test_pipeline,
    #     classes=class_names,
