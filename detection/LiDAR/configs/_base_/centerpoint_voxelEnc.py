...
# voxel_size = [0.075, 0.075, 0.2] # base
voxel_size = [0.056, 0.056, 0.2] # range 40
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            # post_center_range=[-61.2, -61.2, -10.0, 61.2, 61.2, 10.0], # base
    ...
    test_cfg=dict(
        pts=dict(
            # post_center_limit_range=[-61.2, -61.2, -10.0, 61.2, 61.2, 10.0], # base
...
log_level = 'INFO'
work_dir = './work_dirs/sit_centerpoint_voxel/ver3_translation_CBGS_final/'
