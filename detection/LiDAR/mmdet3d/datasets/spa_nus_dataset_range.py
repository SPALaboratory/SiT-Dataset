...
cls_label_map = {'car' : 'car', 'motorcycle': 'motorcycle', 'pedestrian': 'pedestrian', 'bicycle':'bicycle', 'truck':'truck', 'bus':'bus', 'kickboard':'kickboard'}
...
class SPA_Nus_Dataset(Custom3DDataset):
    ...
    # CLASSES = ('car', 'bicycle', 'motorcycle', 'pedestrian', 'truck', 'bus', 'kickboard')
    CLASSES = ('car', 'bicycle', 'motorcycle', 'pedestrian', 'truck', 'bus', 'kickboard')
    def __init__(self,
                 ann_file,
                 pipeline=None,
    ...
    def get_ann_info(self, index):
        ...
        #     gt_bboxes_3d,
        #     box_dim=gt_bboxes_3d.shape[-1],
        #     origin=(0, 0, 0.0)).convert_to(self.box_mode_3d)
        # gt_bboxes_3d = LiDARInstance3DBoxes(
        #     gt_bboxes_3d,
        #     box_dim=gt_bboxes_3d.shape[-1], origin=(0.5, 0.5, 0.5))
        gt_bboxes_3d = LiDARInstance3DBoxes(
    ...
    def evaluate(self,
        ...
        for i, t_ in enumerate(list(result_['results'].keys())):
            ...
            gt_bboxes_3d = data_['gt_boxes'] 
            gt_labels_3d = data_['gt_names']
 
            gt_bboxes_3d_no_transform = copy.deepcopy(data_['gt_boxes']) 
            gt_labels_3d_no_transform = copy.deepcopy(data_['gt_names']) 
            ...
            num_gt_boxes += len(gt_bboxes_3d)
            if len(gt_bboxes_3d)==0:
                empty_scene.append(data_['token'])
...
def output_to_nusc_box(detection, with_velocity=False):
    ...
    # our LiDAR coordinate system -> nuScenes box coordinate system lwh -> wlh
