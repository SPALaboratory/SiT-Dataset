...
class SiT_Dataset(Custom3DDataset):
    ...
    def evaluate(self,
        ...
        for i, t_ in enumerate(list(result_['results'].keys())):
            ...
            _save_path_ = "./range_gt_pred/pointpillars/range_512/"
            ...
            mask = in_range_bev(gt_bboxes_3d, [-51.2, -51.2, 51.2, 51.2]) 
            ...
            for ii in range(self.data_infos[i]['gt_boxes'].shape[0]):
                ...
                d_['size'] = np.abs(_boxes[3:6][[1,0,2]]).tolist() #for nuscene_eval : lwh(in model) -> wlh(nuscene_eval)
