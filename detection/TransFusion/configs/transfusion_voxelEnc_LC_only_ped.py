...
log_level = 'INFO'
work_dir = './work_dirs/transfusion_sit_voxel_LC_only_ped/ver5_resnet50_resize_final/'
load_from = './work_dirs/transfusion_sit_voxel_L_only_ped/ver1_base/latest.pth'
resume_from = None
workflow = [('train', 1)]
# gpu_ids = range(0, 8)
