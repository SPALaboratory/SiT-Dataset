...
optimizer = dict(type='AdamW', lr=1e-4, weight_decay=0.01)  # for 8gpu * 2sample_per_gpu
...
log_level = 'INFO'
work_dir = './work_dirs/transfusion_sit_voxel_L_only_ped/ver1_base/'
load_from = None
resume_from = './work_dirs/transfusion_sit_voxel_L_only_ped/ver1_base/latest.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 8)
