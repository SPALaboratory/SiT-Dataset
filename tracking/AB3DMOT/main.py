...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='spa', help='KITTI, nuScenes, spa')
...
def main_per_cat(cfg, cat, log, ID_start):
    ...
    max_frame_dict = {'0000': 100, '0001': 100, '0002': 100, '0003': 100, '0004': 100, '0005': 100, '0006': 100}
    #  max_frame_dict = {'0000': 100}
    for seq_name in seq_eval:
        ...
        min_frame, max_frame = 0, max_frame_dict[seq_name]
