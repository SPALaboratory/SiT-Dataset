...
class trackingEvaluation(object):
    ...
    def __init__(self, t_sha, gt_path='./scripts/spa', max_truncation = 0, min_height = 25, \
        ...
        # data and parameter
        #  self.gt_path           = os.path.join(gt_path, split, "label")
...
if __name__ == "__main__":
    ...
    if len(sys.argv)!=2 and len(sys.argv)!=4:
      print("Usage: python scripts/spa/evaluate_quick.py result_sha num_hypothesis(e.g., 1) split(train or val)")
      sys.exit(1);
